        ...
        <div className="card w-96 bg-base-100 shadow-2xl border border-default">
          ...
          <div className="card-body items-center text-center ">
            ...
            <div className="card-actions justify-between w-full">
              <label htmlFor="my-modal-6" className="btn bg-orange-600 transition ease-in-out delay-150 hover:scale-105 px-7">I am Over 18</label>
              <label htmlFor="my-modal-6" className="btn btn-outline btn-orange-600 transition ease-in-out delay-150 hover:scale-105 px-7">I am Under 18</label>
            </div>
            <span className='text-overline font-normal pt-2 text-center'>
              <span>By entering this site you are agreering to the</span> 
              <span className='flex'>
                <span className='text-orange-600 mr-1'>terms of use</span> and <span className='text-orange-600 ml-1'>Privacy Policy</span>.
              </span>
            </span>
          </div>
        </div>
