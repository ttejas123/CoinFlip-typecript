...
function SelectToken() {
  ...
  const SelectTokenOnclickHandeler = useCallback((type: "sol"|"t#") => {
  ...
  return (
    <div className='w-full h-full border border-base-300  p-5 rounded-2xl text-base-200'>
              <div className='uppercase bg-base-300 rounded-lg text-overline font-extrabold p-5 my-1 hover:scale-95 cursor-pointer transition-all flex items-center justify-left ' onClick={()=> SelectTokenOnclickHandeler("sol")}> 
