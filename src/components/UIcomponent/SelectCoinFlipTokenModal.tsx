...
function SelectCoinFlipTokenModal() {
  const [numberOfSol, setNumberOfSol] = useState(0);
    ...
    <div>
        <div className="flex items-center justify-center hover:scale-105" >
                <GredientBorder tokentype='solana'>
                    ...
                    <div className='w-full absolute h-full top-0 left-0 rounded-2xl p-5'> 
                        <input onChange={onChangeOfNUmberOfSol} type="number" value={numberOfSol} placeholder="Type here" className="input input-bordered border-2 bg-zinc-300 input-group-xs hover:border-gray-200 h-9 w-full text-accent" />
        ...
        <div className='w-full h-full border border-base-300 mt-4 p-5 rounded-2xl text-base-200'>
              ...
              <div className='grid grid-cols-4 w-full justify-between mt-4'> 
                <div className='btn-token-increase font-bold cursor-pointer hover:scale-90 transition-all py-4 mx-1 text-center rounded-xl' onClick={()=> increaseSolanaByXTime(0.5)} >0.5</div>
                <div className='btn-token-increase font-bold cursor-pointer hover:scale-90 transition-all py-4 mx-1 text-center rounded-xl' onClick={()=> increaseSolanaByXTime(2)} >2</div>
                <div className='btn-token-increase font-bold cursor-pointer hover:scale-90 transition-all py-4 mx-1 text-center rounded-xl' onClick={()=> increaseSolanaByXTime(4)} >4</div>
                <div className='btn-token-increase font-bold cursor-pointer hover:scale-90 transition-all py-4 mx-1 text-center rounded-xl' onClick={()=> increaseSolanaByXTime(6)} >6</div>
              </div>
